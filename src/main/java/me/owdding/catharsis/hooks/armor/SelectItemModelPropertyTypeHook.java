...
public interface SelectItemModelPropertyTypeHook<P extends SelectItemModelProperty<T>, T> {
    ...
    default MapCodec<SelectEquipmentEntityConditionSwitch<P, T>> catharsis$getEquipmentSwitchCodec() {
        throw new UnsupportedOperationException();
    }

    default void catharsis$setEquipmentSwitchCodec(MapCodec<SelectEquipmentEntityConditionSwitch<P, T>> codec) {
        throw new UnsupportedOperationException();
    }
}
