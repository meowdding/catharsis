...
object TextMatchers {
    ...
    @IncludedCodec
    val CODEC: MapCodec<TextMatcher> = ID_MAPPER.codec(Codec.STRING)
        .optionalFieldOf("mode", CatharsisCodecs.getMapCodec<RegexTextMatcher>())
        .dispatchMap(TextMatcher::codec) { it }
