...
object EntityConditions {
    ...
    init {
        ...
        ID_MAPPER.put(Catharsis.id("equipment_conditional"), CatharsisCodecs.getMapCodec<ConditionalEquipmentEntityCondition>())
        ID_MAPPER.put(Catharsis.id("equipment_select"), CatharsisCodecs.getMapCodec<SelectEquipmentEntityCondition<*, *>>())
        ID_MAPPER.put(Catharsis.id("equipment_range_dispatch"), CatharsisCodecs.getMapCodec<RangeSelectEquipmentEntityCondition>())
        ID_MAPPER.put(Catharsis.id("is_baby"), CatharsisCodecs.getMapCodec<BabyEntityCondition>())
        ID_MAPPER.put(Catharsis.id("max_health"), CatharsisCodecs.getMapCodec<MaxHealthEntityCondition>())
