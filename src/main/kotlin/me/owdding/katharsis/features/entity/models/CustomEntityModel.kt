...
import me.owdding.katharsis.utils.geometry.BedrockGeometry
import me.owdding.katharsis.utils.geometry.SafeModelPart
    ...
    data class Variant(
        ...
        fun <T : EntityRenderState> replaceModel(oldModel: EntityModel<T>): EntityModel<T> {
            ...
            val newModel = runCatching {
                ...
                Katharsis.error("Failed to replace a model: Failed to construct ${oldModel.javaClass.name}", it)
