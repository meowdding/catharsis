...
sealed interface PlayerEntityConditions : EntityCondition {
    ...
    data class NpcSkin(
        ...
        override val codec: MapCodec<out EntityCondition> = KatharsisCodecs.getMapCodec<NpcSkin>()
    ...
    data class PlayerSkin(
        ...
        override val codec: MapCodec<out EntityCondition> = KatharsisCodecs.getMapCodec<PlayerSkin>()
