...
data class RandomBlockReplacement(
    ...
    override fun bake(baker: ModelBaker, block: Block): BlockReplacementSelector =
        RandomBlockReplacementSelector(min, max, threshold, definition.bake(baker, block), fallback?.bake(baker, block))
    ...
    data class Completable(
        ...
        override fun bake(bakery: BlockReplacementBakery) = RandomBlockReplacement(min, max, threshold, definition.bake(bakery), fallback?.bake(bakery))
    }
