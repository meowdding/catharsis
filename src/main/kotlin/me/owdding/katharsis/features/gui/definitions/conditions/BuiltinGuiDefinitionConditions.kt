...
import me.owdding.katharsis.features.gui.definitions.conditions.GuiDefinitionAllCondition
import me.owdding.katharsis.features.gui.definitions.slots.SlotCondition
...
import me.owdding.katharsis.utils.CachedFile
...
data class GuiDefinitionAllCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiDefinitionAllCondition>()
...
data class GuiDefinitionNotCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiDefinitionNotCondition>()
...
data class GuiDefinitionAnyCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiDefinitionAnyCondition>()
    override val cost: Int = this.conditions.sumOf { it.cost } + 1
...
data class GuiDefinitionSlotCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiDefinitionSlotCondition>()
    override val cost: Int = this.condition.cost + 1
...
data class GuiDefinitionTitleCondition(val title: TextMatcher) : GuiDefinitionCondition {
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiDefinitionTitleCondition>()
...
data class GuiDefinitionTypeCondition(val menu: GuiMenuType) : GuiDefinitionCondition {
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiDefinitionTypeCondition>()
...
data class GuiDefinitionIslandCondition(val islands: Set<SkyBlockIsland>) : GuiDefinitionCondition {
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiDefinitionIslandCondition>()
...
class GuiDefinitionExternalModConfigCondition private constructor(
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiDefinitionExternalModConfigCondition>()
