...
data class PerAreaBlockReplacement(
    ...
    override fun bake(baker: ModelBaker, block: Block): BlockReplacementSelector =
        PerAreaBlockReplacementSelector(values.mapValues { (_, value) -> value.bake(baker, block) })
    ...
    data class PerAreaBlockReplacementSelector(val values: Map<ResourceLocation, BlockReplacementSelector>) : BlockReplacementSelector {
