...
public class EntityMixin {
    ...
    private SoundEvent katharsis$modifySteapsound(SoundType instance, Operation<SoundEvent> original, @Local(argsOnly = true) BlockPos pos, @Local BlockState blockState) {
