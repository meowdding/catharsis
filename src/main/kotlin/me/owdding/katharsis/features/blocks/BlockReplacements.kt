...
import me.owdding.katharsis.features.blocks.replacements.LayeredBlockReplacements
...
import me.owdding.katharsis.utils.extensions.mapBothNotNull
import me.owdding.katharsis.utils.types.fabric.PreparingModelLoadingPlugin
...
@Module
object BlockReplacements : PreparingModelLoadingPlugin<Map<Block, LayeredBlockReplacements>>, KatharsisLogger by Katharsis.featureLogger() {
    init {
        register()
    }

    private val logger: KatharsisLogger = this
    val blockReplacementConverter: FileToIdConverter = FileToIdConverter.json("katharsis/block_replacements")
    val blockStateConverter: FileToIdConverter = FileToIdConverter.json("katharsis/virtual_block_states")
    ...
    val virtualBlockStateCodec: Codec<VirtualBlockStateDefinition> = KatharsisCodecs.VirtualBlockStateDefinitionCodec.codec()
    ...
    override fun prepare(
        ...
        return CompletableFuture.supplyAsync(
            ...
            if (throwable != null) {
                Katharsis.error("Failed to prepare block replacements!", throwable)
            }
        }
    }
