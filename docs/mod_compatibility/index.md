...
# <Environment /> Mod Compatibility with Catharsis

Catharsis features an API allowing other mods to interact with its retexturing.
...
If your Texture Pack relies on more dependencies than just Catharsis,
