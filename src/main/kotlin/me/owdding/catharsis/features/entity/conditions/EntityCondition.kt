...
object EntityConditions {
    ...
    init {
        ...
        ID_MAPPER.put(Catharsis.id("equipment_select"), SelectEquipmentEntityCondition.CODEC)
        ID_MAPPER.put(Catharsis.id("equipment_range_dispatch"), RangeSelectEquipmentEntityCondition.CODEC)
