...
import me.owdding.katharsis.features.gui.matchers.TextMatcher
import me.owdding.katharsis.features.imc.ImcHandler.isDisabled
...
import me.owdding.katharsis.utils.extensions.extremesOf
import me.owdding.katharsis.utils.types.Base64String
import me.owdding.katharsis.utils.types.IntPredicate
...
data class SlotAllCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<SlotAllCondition>()
...
data class SlotAnyCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<SlotAnyCondition>()
    override val cost: Int = this.conditions.sumOf(SlotCondition::cost) + 1
...
data class SlotNotCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<SlotNotCondition>()
...
data class SlotIndexCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<SlotIndexCondition>()
...
data class SlotSkyBlockIdCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<SlotSkyBlockIdCondition>()
...
data class SlotItemCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<SlotItemCondition>()
...
data class SlotNameCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<SlotNameCondition>()
...
data class SlotLoreCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<SlotLoreCondition>()
    override val cost: Int = this.matcher.cost
...
data class SlotIslandCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<SlotIslandCondition>()
...
data class HasComponentCondition(
    ...
    override val codec = KatharsisCodecs.getMapCodec<HasComponentCondition>()
...
data class RelativeSlotCondition(
    ...
    override val codec: MapCodec<out SlotCondition> = KatharsisCodecs.getMapCodec<RelativeSlotCondition>()
    override fun matches(slots: List<Slot>, slot: Int, stack: ItemStack): Boolean {
...
data class SlotBorderCondition(
    ...
    override val codec: MapCodec<SlotBorderCondition> = KatharsisCodecs.getMapCodec<SlotBorderCondition>()
    override fun matches(slots: List<Slot>, slot: Int,  stack: ItemStack): Boolean {
