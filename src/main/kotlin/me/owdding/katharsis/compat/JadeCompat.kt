...
import me.owdding.katharsis.features.blocks.BlockDisplayDefinition
import me.owdding.katharsis.features.blocks.BlockDisplayDefinition.Companion.isSkyblockBlock
...
object JadeCompat : IWailaPlugin, JadeRayTraceCallback, JadeItemModNameCallback {
    ...
    private object RemoveVanillaInfoProvider : IBlockComponentProvider {
        ...
        override fun getUid(): Identifier = Katharsis.id("remove_vanilla_info")
    ...
    private object CustomBlockProvider : IBlockComponentProvider {
        ...
        override fun isRequired(): Boolean = true
        override fun getUid(): Identifier = Katharsis.id("custom_block_info")
