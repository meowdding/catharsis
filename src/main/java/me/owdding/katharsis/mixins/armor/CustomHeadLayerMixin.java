...
public class CustomHeadLayerMixin {
    ...
    private void katharsis$modifyRenderTypeForCustomHeadLayer(
        ...
        if (!(state instanceof LivingEntityRenderStateHook hook) || !(hook.katharsis$getArmorDefinitionRenderState().getHead() instanceof ArmorModelState.Bedrock)) {
