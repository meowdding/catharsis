...
import me.owdding.katharsis.features.gui.modifications.elements.interactions.GuiSlotClickWidgetInteraction
import me.owdding.katharsis.features.gui.modifications.elements.interactions.GuiSlotIdClickWidgetInteraction
...
data class TextWidgetTooltip(@Compact val text: List<Component>) : GuiWidgetTooltip {
    ...
    override val codec = KatharsisCodecs.getMapCodec<TextWidgetTooltip>()
...
data class SlotWidgetTooltip(val slot: Int) : GuiWidgetTooltip {
    override val codec = KatharsisCodecs.getMapCodec<SlotWidgetTooltip>()
...
data class SlotIdWidgetTooltip(val slot: Identifier) : GuiWidgetTooltip {
    override val codec = KatharsisCodecs.getMapCodec<SlotIdWidgetTooltip>()
...
data class SkyBlockIdWidgetTooltip(val id: SkyBlockId, val withName: Boolean = true, val withLore: Boolean = true) : GuiWidgetTooltip {
    override val codec = KatharsisCodecs.getMapCodec<SkyBlockIdWidgetTooltip>()
...
object WidgetTooltips {
    ...
    init {
        ID_MAPPER.put(Katharsis.id("text"), KatharsisCodecs.getMapCodec<TextWidgetTooltip>())
        ID_MAPPER.put(Katharsis.id("slot"), KatharsisCodecs.getMapCodec<SlotWidgetTooltip>())
        ID_MAPPER.put(Katharsis.id("slot_id"), KatharsisCodecs.getMapCodec<SlotIdWidgetTooltip>())
        ID_MAPPER.put(Katharsis.id("id"), KatharsisCodecs.getMapCodec<SkyBlockIdWidgetTooltip>())
        ID_MAPPER.put(Katharsis.id("interaction"), InteractionWidgetTooltip.codec)
    }
}
