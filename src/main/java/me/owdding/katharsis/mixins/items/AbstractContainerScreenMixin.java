...
import me.owdding.katharsis.features.tooltip.TooltipFeature;
...
public class AbstractContainerScreenMixin {
    ...
    private void katharsis$renderItem(GuiGraphicsExtractor instance, ItemStack stack, int x, int y, int seed, Operation<Void> original, @Local(argsOnly = true) Slot slot) {
    ...
    private <T> T katharsis$wrapGetTooltipStyle(ItemStack instance, DataComponentType<@NotNull T> dataComponentType, Operation<T> original) {
