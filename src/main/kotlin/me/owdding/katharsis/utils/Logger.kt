...
interface KatharsisLogger {

    companion object Companion {
        internal val STACK_WALKER = StackWalker.getInstance(StackWalker.Option.RETAIN_CLASS_REFERENCE)
        fun named(name: String): KatharsisLogger = LoggerImpl(LoggerFactory.getLogger(name))
        fun autoResolve(): KatharsisLogger = LoggerImpl(LoggerFactory.getLogger(STACK_WALKER.callerClass.simpleName))

        fun KatharsisLogger.featureLogger(): KatharsisLogger {
    ...
    fun featureLogger(name: String): KatharsisLogger
...
internal data class LoggerImpl(val logger: Logger, val defaultPrefix: String? = null) : KatharsisLogger {
    ...
    override fun featureLogger(name: String): KatharsisLogger {
        return LoggerImpl(logger, mergedPrefix(name))
    }
