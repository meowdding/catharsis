package me.owdding.katharsis.utils.codecs
...
import me.owdding.katharsis.utils.Utils
import me.owdding.katharsis.utils.types.Base64String
import me.owdding.katharsis.utils.types.requireBase64Padding
...
object IncludedCodecs {
    ...
    @IncludedCodec(named = "katharsis_identifier", keyable = true)
    val katharsisIdentifier: Codec<Identifier> = Codec.STRING.xmap(
        { Utils.resourceLocationWithDifferentFallbackNamespace(it, Identifier.NAMESPACE_SEPARATOR, Katharsis.MOD_ID) },
        { it.toString() },
    )
