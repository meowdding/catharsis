...
data class NotBlockCondition(val condition: BlockCondition): BlockCondition {
    ...
    override val codec: MapCodec<out BlockCondition> = KatharsisCodecs.getMapCodec<NotBlockCondition>()
...
data class AndBlockCondition(val conditions: List<BlockCondition>): BlockCondition {
    ...
    override val codec: MapCodec<out BlockCondition> = KatharsisCodecs.getMapCodec<AndBlockCondition>()
...
data class OrBlockCondition(val conditions: List<BlockCondition>): BlockCondition {
    override val codec: MapCodec<out BlockCondition> = KatharsisCodecs.getMapCodec<OrBlockCondition>()
