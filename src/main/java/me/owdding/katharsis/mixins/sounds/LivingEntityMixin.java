package me.owdding.katharsis.mixins.sounds;
...
public class LivingEntityMixin {
    ...
    public BlockPos katharsis$blockpos(BlockPos original, @Share("position") LocalRef<BlockPos> blockPos) {
    ...
    public SoundEvent katharsis$modifySound(SoundType instance, Operation<SoundEvent> original, @Share("position") LocalRef<BlockPos> blockPos, @Local BlockState blockState) {
