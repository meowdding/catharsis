...
object TooltipFeature : SimplePreparableReloadListener<TooltipDefinition?>() {
    ...
    override fun prepare(manager: ResourceManager, profiler: ProfilerFiller): TooltipDefinition? {
        ...
        val reader = manager.getResource(Katharsis.id("tooltip.json")).getOrNull()?.openAsReader() ?: return null
    ...
    init {
        McClient.registerClientReloadListener(Katharsis.id("tooltip_definition"), this)
    }
}
