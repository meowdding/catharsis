...
- Add a block: `/katharsis dev area_select add block <id>`
- Remove a block: `/katharsis dev area_select remove block <id>`
- View the current list: `/katharsis dev area_select list`
- Clear all blocks: `/katharsis dev area_select clear`
...
If you want to abort the flood fill, you can run `/katharsis dev area_select cancel`.
:::
...
When a selection finishes, Katharsis will send a clickable message in chat.
