...
import me.owdding.katharsis.features.misc.AnimatableSimpleTexture;
...
public abstract class TextureManagerMixin {
    ...
    private SimpleTexture katharsis$onTextureCreate(Identifier location, Operation<SimpleTexture> original) {
    ...
    private boolean katharsis$isTickable(Object obj, Operation<Boolean> original) {
    ...
    private void katharsis$onTextureReloaded(ReloadableTexture instance, TextureContents contents, Operation<Void> original) {
