...
data class GuiLinkWidgetInteraction(
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiLinkWidgetInteraction>()
...
data class GuiSlotClickWidgetInteraction(
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiSlotClickWidgetInteraction>()
    override fun click(button: Int) {
...
data class GuiSlotIdClickWidgetInteraction(
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiSlotIdClickWidgetInteraction>()
...
data class GuiCommandWidgetInteraction(
    ...
    override val codec = KatharsisCodecs.getMapCodec<GuiCommandWidgetInteraction>()
    override fun click(button: Int) {
        if (CommandWhiteList.isWhitelisted(command)) {
            McClient.sendCommand(command)
        } else {
            Katharsis.warn("Command '$command' is not whitelisted")
        }
    }
}
